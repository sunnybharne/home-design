...
export const shopping = [
  ...
  { id: 'lisabo-table', name: 'LISABO', type: 'Dining table', finish: 'Ash veneer', size: [1.40, .78, .74], room: 'Dining', url: ikea('LISABO pöytä 140 78'), note: 'Natural grain, rounded corners and tapered legs.' },
  { id: 'lisabo-chair', name: 'LISABO', type: 'Dining chair', finish: 'Ash', size: [.44, .51, .80], room: 'Dining + studio', url: ikea('LISABO tuoli saarni'), note: 'Four dining chairs plus one desk chair. Allow pull-out space; try the chair before long editing sessions.' },
  ...
  { id: 'regolit', name: 'REGOLIT', type: 'Paper pendant shade', finish: 'White rice paper', size: null, room: 'Living, dining and bedroom', url: ikea('REGOLIT 45'), note: '45 cm shade reference. Choose a compatible cord set; hanging heights are styling estimates.' },
...
export const concept = {
  ...
  dimensions: 'Nominal IKEA range dimensions, not verified against today’s product pages. Models are original approximations, not official IKEA 3D assets.',
...
export const furnishingLayout = [
  ...
  { id: 'coffee', product: 'listerby', kind: 'coffee', x: 6.68, z: 4.72, rotation: 0 },
  { id: 'tv', product: 'besta', kind: 'console', x: 6.45, z: 3.49, rotation: 0 },
  { id: 'dining', product: 'lisabo-table', kind: 'table', x: 3.05, z: 4.68, rotation: Math.PI / 2 },
  ...[[-1, -1], [1, -1], [-1, 1], [1, 1]].map(([side, end], i) => ({ id: `dining-chair-${i}`, product: 'lisabo-chair', kind: 'chair', x: 3.05 + side * .71, z: 4.68 + end * .39, rotation: side < 0 ? Math.PI / 2 : -Math.PI / 2 })),
...
export const cameraViews = {
  ...
  living: { name: 'Living & dining', x: 4.46, z: 3.86, eye: 1.60, target: [6.6, 1.0, 5.7], fov: 55 },
