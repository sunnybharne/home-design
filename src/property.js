...
export const rooms = [
  { id: 'living', number: '01', name: 'Living / dining / kitchen', short: 'LIVING / KITCHEN', code: 'OH · RT · KT', label: [5.15, 4.65], color: finishes.floor.color, polygon: [[2.025, 3.25], [8.39, 3.25], [8.39, 7.04], [2.025, 7.04]], description: 'A proposed 140 × 80 cm island replaces the dining table, with two stools and a 120 cm kitchen aisle. The sofa faces the TV across an open rug, with no coffee table. Terrace access around the sofa is narrow: about 60 cm behind and 57 cm beside it in the model. Check actual clearances on site. Selected beige kitchen; documented worktop: 2722 × 600 mm (S05; S12 p.10).' },
