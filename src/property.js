...
export const rooms = [
  { id: 'living', number: '01', name: 'Living / dining / kitchen', short: 'LIVING / KITCHEN', code: 'OH · RT · KT', label: [5.15, 4.65], color: finishes.floor.color, polygon: [[2.025, 3.25], [8.39, 3.25], [8.39, 7.04], [2.025, 7.04]], description: 'Open kitchen floor with no island or stools. The sofa sits 90 cm closer to the TV, leaving about 150 cm behind it and a modeled 90 cm route around its kitchen-side end to the terrace. No coffee table. Extra 40 cm upper cupboards combine beige doors, two green glass fronts and warm lighting; gaps remain above the fridge and extractor. Check fit and clearances on site. Original beige kitchen; worktop: 2722 × 600 mm (S05; S12 p.10).' },
