...
export const rooms = [
  { id: 'living', number: '01', name: 'Living / dining / kitchen', short: 'LIVING / KITCHEN', code: 'OH · RT · KT', label: [5.15, 4.65], color: finishes.floor.color, polygon: [[2.025, 3.25], [8.39, 3.25], [8.39, 7.04], [2.025, 7.04]], description: 'Proposed 140 × 80 cm island, two stools and a 120 cm kitchen aisle. Extra 40 cm upper cupboards combine beige doors, two green glass fronts and warm lighting; gaps remain above the fridge and extractor. The sofa faces the TV with no coffee table. Terrace access is narrow: about 60 cm behind and 57 cm beside the sofa. Check fit and clearances on site. Original beige kitchen; worktop: 2722 × 600 mm (S05; S12 p.10).' },
