...
export const rooms = [
  { id: 'living', number: '01', name: 'Living / dining / kitchen', short: 'LIVING / KITCHEN', code: 'OH · RT · KT', label: [5.15, 4.65], color: finishes.floor.color, polygon: [[2.025, 3.25], [8.39, 3.25], [8.39, 7.04], [2.025, 7.04]], description: 'A provisional 100 cm round table with two chairs represents your existing IKEA table; its model and size still need confirming. The island and coffee table are removed. The sofa sits closer to the TV, leaving about 150 cm behind it and a modeled 90 cm terrace route. Extra 40 cm upper cupboards have green glass fronts and warm lighting. Check furniture fit, chair use and clearances on site. Original beige kitchen; worktop: 2722 × 600 mm (S05; S12 p.10).' },
  ...
  { id: 'bedroom-2', number: '03', name: 'Lower bedroom / studio', short: 'STUDIO / GUEST', code: 'MH', label: [3.92, 8.35], color: finishes.floor.color, polygon: [[2.115, 7.22], [5.89, 7.22], [5.89, 10.215], [2.115, 10.215]], description: 'Proposed guest room / YouTube studio: HEMNES daybed (closed), LAGKAPTEN / ALEX desk and a BILLY backdrop. The fixed Novart cabinet group remains: 500 + 500 mm modules, 30 mm filler, 2112 + 166 mm height (S07). Check the opened bed, chair travel and recording setup on site.' },
